                    ...
                    <form action="delete-course.php" method="GET">
                        ...
                        '<div class="form-group">
                             <label class="control-label col-sm-2" for="choosenSubjects">Subjects</label>
                                <div class="col-sm-10">';
                                for ($x; $x <= $count4; $x++){    
                                //DISPLAYING ENROLLED COURSES AS CHECKBOXES            
...
<div class="modal fade" id="editModal3" role="dialog">
    <div class="modal-dialog">
            ...
            <div class="modal-body">
               <!-- Modal Body -->
                <form action="addcourses.php" method="GET">
                    ...
                    //DISPLAYING courses which have not already been selected by the student
                    ...
                    <div class="form-group">
                        ...
                        //If student has already been enrolled in all the courses of a class
                        if($counter ==0){
                            ...
                            for ($x; $x <= $counter; $x++){
                            //DISPLAYING courses as checkboxes
                            echo '<div class="checkbox">
        ...
        <div>
            ...
            <br>
            <!-- DISPLAYING TUTORS OF THE STUDENT -->
