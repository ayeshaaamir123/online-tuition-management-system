            ...
            for ($x =1; $x <= $count; $x++) {
                ...
                if (isset($_GET[$subject])){
                    ...
                    for ($x1 =1; $x1 <= $count2; $x1++) {
                        ...
                        //DELETING THE STUDENTS BEING TAUGHT THAT PARTICULAR COURSE BY THE TUTOR FROM student_tutor
                        $delete_student="DELETE FROM student_tutor WHERE student_id='$student_id' and tutor_id='$tutor_id';";
                        //ASSIGNING A DEFAULT TUTOR TO THE STUDENT
                        $ins_def="INSERT INTO `onlinetuitionmanagementsystem`.`student_tutor` (`tutor_id`, `student_id`) VALUES ('default@gmail.com', '$student_id');";
